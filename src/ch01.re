...
これにより「あれも入れたい」といった、思いつきのアイデアに影響されず、一気に Web サイトを作ることが可能です。
...
Web サイト内にある、ボタン・画像・テキストなど、さまざまな情報表示・動作するものを、Web サイトの「要素」と呼びます。
...
場合により、ワイヤーフレームと仕様書は、両方をまとめたり分けて書くこともあります。Web サイトの内容が豊かであればあるほど、仕様書も内容は多くなるので、分けて書くことをおすすめします。
