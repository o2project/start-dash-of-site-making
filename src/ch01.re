...
場合によって、両方をまとめて書くこともあるが、分けて書くこともあります。
...
何故かと言うと、ワイヤーフレームを参考にデザイナがグラフィックと UI の制作を行うので、余計な情報があると資料自体がわかりづらくなり、混乱を招く可能性があります。
どんなグラフィックや UI の方向性にするかは、アートディレクタの仕事なので、企画資料としては見やすいようにすることが最優先です。
...
ちょっと説明すると、もともと「ニコニコ動画」のようなコメント機能があると思われますが、今回は工数が足りないためちょっと改造して、「何かをコメントする」という似てる体験をユーザに与えるため SNS コメントという形にしました。



//image[ch1_04][ライブステージのワイヤーフレーム]{
//}
...
//image[ch1_05][まだ作っていないというポップアップのワイヤーフレーム]{
//}

//image[ch1_06][SNS のコメントポップアップのワイヤーフレーム]{
//}

//image[ch1_07][投票結果を再現するためのワイヤーフレーム]{
//}
