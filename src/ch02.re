 ...
 * @<href>{https://html5experts.jp/nakajmg/8931/,Google のベストプラクティスに沿ったモダンな製作の出発点「 Web Starter Kit 」 | HTML5Experts.jp}
...
例えば @<href>{http://getbootstrap.com/,Bootstrap} だと、ページ下部に Bootstrap を使ったサイト一覧が掲載されています。
...
ソースコードの把握がしやすいか見ます。全体把握しやすいライブラリとしては、例えば @<href>{http://backbonejs.org/,Backbone.js} が挙げられます。
