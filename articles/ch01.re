...
そのためこの本に出てくるソースコードはMITライセンスである旨と@<tt>{Copyright (c) 2015 O2 Project}という著作権を表示すれば自由に使うことができます。
...
クリエイティブ・コモンズについては@<href>{http://liskul.com/cr_ccnotrouble-4194,クリエイティブ・コモンズ｜商用利用でトラブルを避ける全知識}という記事が分かりやすいです。
