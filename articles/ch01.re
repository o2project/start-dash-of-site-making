 ...
 * 質問：どんなサイトを作りたいですか。
 * 回答：「ラブライブ！」というイベントの情報を発信するサイトを作りたいです。
 * 質問：どんな情報を発信したいですか。
 * 回答：イベントの開催日・参加者・またはチケット情報などを発信したいです。また現場へ来れない人のためにネットでライブを楽しめる機能があったら便利です。
 * 回答：そして主催側としてはイベントがいろんな人に知られるとうれしいので、SNSなどで簡単に拡散できる機能が欲しいです。
